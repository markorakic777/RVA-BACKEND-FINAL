 ...
 * 
 */
@JsonIgnoreProperties({"hibernateLazyInitialiyer", "handler"})
@Entity
...
public class StavkaPorudzbine implements Serializable {
	...
	@Column(name="jednica_mere")
	private String jednicaMere;
	...
	public String getJednicaMere() {
		return this.jednicaMere;
	}

	public void setJednicaMere(String jednicaMere) {
		this.jednicaMere = jednicaMere;
	}
